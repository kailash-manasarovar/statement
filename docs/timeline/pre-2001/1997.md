...
- We skip Altea, Moiraira, Javea, Benissa, etc, and instead pull off the motorway at Dénia and drive through the not very picturesque way into the town on the way to find the beach.
...
- Not only is Matt Paul's brother, but he was also *exceedingly* (under-exaggerated) good friends with, ahem, Ray Archer at that time also.
