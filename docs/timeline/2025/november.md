...
- On these occasions, the *only* accounts posting anything on my timeline seemed to be aggressive stalker fake-accounts; her [flying monkeys](../2024/march/1-12.md#online-stalkers), as it were.
- Clearly, any device's hacked browser's social media feeds can be 100% manipulated, and the manipulation can take multiple forms.
...
- Once in and jumping into an open session as owner, manipulating everything the true owner sees must be very easy.
...
- For example, in my case, here's an idea of how those varying prompts might have read:
...
- Furthermore, this suicide content on my feed I have never seen before supports my suspicion that Lorraine Blackbourn, and others in the area and at the conservatory, have been manipulated online into committing suicide.
