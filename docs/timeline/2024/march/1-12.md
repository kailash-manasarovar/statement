...
- I believe I was supposed to think it was Ana Requena as many posts referenced a relationship of some sort, and this man's *daughters*, and how the relationship was constantly faltering.
- The name also referenced Ana Girbes in her fierce aviator form.
- The account tag-teamed with other accounts during this period, with the specific intention of cyber-stalking myself, such as with the [`@SeonaidDawn`](#seonaiddawn) account below.
...
- Many of the account's tweets, and tweet-replies to me have been deleted.
...
- This account is also involved in continued gaslighting, and here is an exceptionally good example of the sort of thing the gaslighter's, such as [Chris BJ](13-end.md#chris-bj-by-gaslight), would say, as if they were reading from a manual.

![Gaslight example](../../../content/tweets/march-2024/ani-loviator/aniloviator-gaslighting.png)

- I heard these very words from [Chris BJ](13-end.md#or-gaslit-by-chris-bj), and Sandra Diaz - always timed for the most extreme moments of stress such as when I was being poisoned with the intent to kill.
- Notice the *same gaslighting message popping up in first place on Google search* in [September 2024](../../2024/september.md#google-searches), as I was being drugged and poisoned so much so that I was hallucinating, badly, in my apartment, criminal gangs closing in with whatever they had planned for me all along.
