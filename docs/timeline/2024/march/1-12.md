...
- This account is also involved in continued gaslighting, and here is an exceptionally good example of the sort of thing the gaslighters, such as [Chris BJ](13-end.md#chris-bj-by-gaslight), would say, as if they were reading from a manual.
...
- Notice the *same gaslighting message popping up in first place on Google search* in [September 2024](../../2024/september.md#google-searches) (scroll down to the bottom pic in the liast), during the time I was being drugged and poisoned so much so that I was hallucinating, badly, in my own home, criminal gangs closing in on me with whatever they had planned for me all along.
