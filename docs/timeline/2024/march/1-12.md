...
- Aside from that, which I believe came from an elaborate and extremely process-expensive AI tech-system designed to spin-up 1000s of account to target normal people with specific emotional content (in my case fear anxiety and threat over this period, but previously and again in the not so distant future it will be sexual desire) there were some repeat offenders using the same account over and over, as we have seen, and stalking me via those.
