...
- I also contacted some other old friends about it including [Paul](../2025/january.md#paul) and Brian's brother Niall (who sounded like Henry's Cat when he spoke).
- Niall Higgins blocked me after I messaged him one word: *Ugly*.
- And Paul gaslit me, again, which is really getting very boring.

### Free SMS from the browser

- Something significant probably was that Brian and I communicated intensely via an Internet service that allowed you to send free SMS's to any mobile direct from a browser.
- I mean, could this have been possible, or was I given access to an industrial-scale criminal-hack so that I could communicate with Brian and be monitored doing so?
- Committing for thought, then removing.
